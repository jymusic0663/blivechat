...
if os.path.exists('/root/blivechat/blcsdk'):
    # Docker环境
    sys.path.append('/root/blivechat')
else:
    # 本地环境
...
logger = logging.getLogger('danmaku-saver')
...
def init_logging():
    filename = os.path.join(config.LOG_PATH, 'danmaku-saver.log')
